...
export function WorkCard({ workId, title, authorId, authorName, tags = [], reason, reasonTone = "affinity", progress, meta, actionLabel, onAction, onOpenAuthor, menuItems = [], featured = false, menuOpen = false }: {
